...
$('#deliveryAddress').validate({ // initialize the plugin
    rules: {
        description: {
            required: true
        },
...
$('#volunteer-form').validate({ // initialize the plugin
    rules: {
        name: {
            required: true
        },
        ...
        mobile_no: {
            required: true,
            matches: "([0-9]{10})|(\([0-9]{3}\)\s+[0-9]{3}\-[0-9]{4})",  // <-- no such method called "matches"!
	        minlength:10,
	        maxlength:10
        },
        address_line_1: {
