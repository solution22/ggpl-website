<?php
/**
 * File name: WebsiteTestimonials.php
 ...
 */
class WebsiteTestimonials extends Model implements HasMedia
{
    use HasMediaTrait {
        getFirstMediaUrl as protected getFirstMediaUrlTrait;
    }

    public $table = 'website_testimonials';
