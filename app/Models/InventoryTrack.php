...
class InventoryTrack extends Model implements HasMedia
{
     ...
     */
    public static $rules = [
        'inventory_track_type' => 'required',
        'inventory_track_date' => 'required',
        'inventory_track_product_id' => 'required',
        'inventory_track_product_quantity' => 'required|numeric|min:0',
        'inventory_track_product_uom' => 'required'
    ];
    ...
    protected $casts = [
        ...
        'inventory_track_category' => 'string',
        'inventory_track_type' => 'string',
        'inventory_track_date' => 'string',
        'inventory_track_product_id'  => 'integer',
        'inventory_track_product_quantity' => 'double',
        'inventory_track_product_uom' => 'string',
        'inventory_track_description' => 'string',
        'inventory_track_usage' => 'integer'
    ];
    /**
     * New Attributes
     *
